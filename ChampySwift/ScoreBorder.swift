...
public class ScoreBorder: UIView {
  ...
  @IBInspectable public var glowMode: ScoreBorderGlowMode = .Forward {
    didSet {
      progressLayer.glowMode = glowMode
    }
  }
  //    0.4
  @IBInspectable public var progressThickness: CGFloat = 0.8  {//Between 0 and 1
    didSet {
  ...
  //here // 0.5
  @IBInspectable public var trackThickness: CGFloat = 0.2 {//Between 0 and 1
    didSet {
  ...
  private class KDCircularProgressViewLayer: CALayer {
    ...
    private struct GlowConstants {
      private static let sizeToGlowRatio: CGFloat = 0.00000
      static func glowAmountForAngle(angle: Int, glowAmount: CGFloat, glowMode: ScoreBorderGlowMode, size: CGFloat) -> CGFloat {
        switch glowMode {
        case .Forward:
