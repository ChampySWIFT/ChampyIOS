//
//  StepCounterDuelChecked.swift
//  Champy
//
//  Created by Azinec Development on 1/6/17.
...
@IBDesignable class StepCounterDuelChecked: UIView {
  ...
  func loadViewFromNib() -> UIView {
    ...
    let nib    = UINib(nibName: "StepCounterDuelChecked", bundle: bundle)
